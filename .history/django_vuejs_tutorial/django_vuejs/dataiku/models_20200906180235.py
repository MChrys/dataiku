...
class Run(models.Model):
    ...
    def __str__(self):
        return str("{}_{}".format(str(self.session_link),str(self.question_link)))
...
class Posibility(models.Model):
    ...
    question_link = models.ForeignKey(Question,to_field='text', null=True, blank=True,on_delete=models.CASCADE)
...
class Answer(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    connected_run = models.ForeignKey(Run,blank=True,null=True,on_delete= models.SET_NULL, db_constraint=False)
    choice  = models.ForeignKey(Posibility,blank=True,null=True,on_delete= models.SET_NULL, db_constraint=False)
