...
class Task(models.Model):
    ...
    task = models.ForeignKey('self', on_delete=models.SET_NULL)
...
class Question(models.Model):
    ...
    certification = models.ForeignKey(QCM, on_delete= models.SET_NULL)
...
class Answer(models.Model):
    ...
    run = models.ForeignKey(Run,blank=True,null=True,on_delete= models.SET_NULL)


class Posibility(models.Model):
    question = models.ForeignKey(Question,on_delete=models.CASCADE)
    text = models.CharField(max_length=255, null=True, blank=True)
    rank = models.ForeignKey(Answer, on_delete= models.SET_NULL)
