...
class Posibility(models.Model):
    ...
    question_link = models.ForeignKey(Question,to_field='serial_num', null=True, blank=True,on_delete=models.CASCADE)
...
class Answer(models.Model):
    ...
    choice  = models.ForeignKey(Posibility,to_field='serial_num',blank=True,null=True,on_delete= models.SET_NULL)
    connected_run = models.ForeignKey(Run,to_field='serial_num',blank=True,null=True,on_delete= models.SET_NULL)
    def __str__(self):
        return self.choice
