...
def author_books_formset(request, author_id):
    '''
    user = request.user
    ...
    author, _ = AuthorContainer.objects.get_or_create(id=author_id)
    print('SESSION')
...
class AuthorList(ListView):
    ...
    template_name='django_formset_vuejs/author_list.html'
